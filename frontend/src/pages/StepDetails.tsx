    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-zinc-900 dark:to-zinc-950">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-12 gap-6">
          ...
          {/* Exercise Detail + Recommended Videos - droite */}
          <div className="col-span-12 md:col-span-8 grid grid-cols-12 gap-6">
            {/* Exercise Detail - gauche dans cette partie */}
            ...
            {/* Recommended Videos - droite dans cette partie */}
            {selectedExercise?.recommended_videos &&
              selectedExercise.recommended_videos.length > 0 && (
                <div className="col-span-12 lg:col-span-4 flex flex-col gap-4 overflow-y-auto max-h-[75vh]">
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">
                    Vidéos recommandées
                  </h3>
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white dark:bg-zinc-800 rounded-xl p-6 w-[90%] max-w-md shadow-xl border border-gray-200 dark:border-zinc-700">
            ...
            <input
              ...
              className="w-full mb-4 rounded-md border border-gray-300 dark:border-zinc-700 px-3 py-2 text-gray-900 dark:text-gray-100 bg-white dark:bg-zinc-900 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            />

            <div className="flex justify-end gap-4">
              <button
                onClick={() => setShowScheduler(false)}
                className="px-4 py-2 rounded-md bg-gray-200 dark:bg-zinc-700 text-gray-700 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-zinc-600 transition"
              >
                Annuler
              </button>
              <button
